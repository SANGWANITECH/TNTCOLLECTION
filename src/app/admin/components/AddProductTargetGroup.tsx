        ...
        <div className="card w-full p-2 rounded-xl relative">
            ...
            >
                <p className="flex gap-2 items-center font-medium">
                    ...
                    <span className="text-sm">{selectedTargetGroup || "Select Group"}</span>
                </p>
            ...
            {open && (
                <div
                    className="card flex flex-col gap-1 mt-2 absolute left-0 right-0 top-8 z-20
                     bg-card dark:bg-card rounded-xl shadow-xl p-2
                     lg:static lg:shadow-none lg:p-0 lg:bg-transparent"
                >
                    {STATIC_TARGET_GROUPS.map(tab => {
